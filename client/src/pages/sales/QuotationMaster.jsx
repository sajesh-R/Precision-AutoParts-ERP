  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingBottom: '16px', borderBottom: '1px solid var(--border-color)', marginBottom: '16px' }}>
        ...
        <button className="btn btn-primary" onClick={() => { setFormData({ items: [], summary: {}, quotationNumber: 'QTN-' + Math.random().toString(36).substring(2, 8).toUpperCase() }); setEditingId(null); setIsModalOpen(true); }}>
        ...
        <form onSubmit={handleSave}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            <div className="input-group">
              ...
              <input type="text" className="input-field" required readOnly value={formData.quotationNumber || ''} onChange={e => setFormData({...formData, quotationNumber: e.target.value})} />
            </div>
            <div className="input-group">
